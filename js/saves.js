...
Decimal.prototype.tetraflow = function (number,start,power) { // EXPERIMENTAL FUNCTION - x => 10^^((slog10(x)-slog10(s))*p+slog10(s))
...
function exporty() {
    ...
    a.download = "Incremental Mass Rewritten 22222's NG+2 Save - "+new Date().toGMTString()+".txt"
    a.click()
}
